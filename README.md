...
<!-- STATS_START -->
_As of 2026-02. Peak = each city's all-time high cumulative index since Dec 2010 (base=100). Drop is expressed as a negative percent; 0% means the city is still at its peak._

| Metric | New Home | Existing Home |
|---|---|---|
| Avg drop, 30 worst-hit cities | -19.58% | -28.37% |
| Avg drop, all cities (69 / 70) | -14.91% | -23.93% |
| Biggest drop | **Luzhou** -24.89% (peak 2019-05) | **Mudanjiang** -43.92% (peak 2011-04) |
| Smallest drop | **Hangzhou** -0.60% (peak 2025-10) | **Chengdu** -13.13% (peak 2023-06) |
...
<!-- GROWTH_START -->
_As of 2026-02. Growth at price peak = each city's cumulative growth from Dec 2010 (base=100, period 0) to its all-time peak. Measures how much prices rose at each city's highest point relative to the start of the series._
