...
<!-- STATS_START -->
_As of 2026-06. Peak = each city's all-time high cumulative index since Dec 2010 (base=100). Drop is expressed as a negative percent; 0% means the city is still at its peak._

| Metric | New Home | Existing Home |
|---|---|---|
| Avg drop, 30 worst-hit cities | -20.50% | -29.23% |
| Avg drop, all cities (69 / 70) | -15.56% | -24.71% |
| Biggest drop | **Luzhou** -26.60% (peak 2019-05) | **Mudanjiang** -44.37% (peak 2011-04) |
| Smallest drop | **Hangzhou** 0.00% (peak 2026-06) | **Shanghai** -12.46% (peak 2023-03) |
...
<!-- GROWTH_START -->
_As of 2026-06. Growth at price peak = each city's cumulative growth from Dec 2010 (base=100, period 0) to its all-time peak. Measures how much prices rose at each city's highest point relative to the start of the series._

| Metric | New Home | Existing Home |
|---|---|---|
| Avg growth at price peak, 30 top-growth cities | +83.72% | +59.84% |
| Avg growth at price peak, all cities (69 / 70) | +60.39% | +38.97% |
